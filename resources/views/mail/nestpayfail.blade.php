...
<head>
    <title> eKarte - Kartično plaćanje </title>
    <!--[if !mso]><!-- -->
...
<div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">
    eKarte - Kartično plaćanje
</div>
<div style="background-color:#E7E7E7;">
    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
           style="background:#0482b4;background-color:#0482b4;width:100%;">
        <tbody>
        <tr>
            <td>
                <!--[if mso | IE]>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td style="width:180px;">
                                                            <a href="https://ekarte.rs" target="_blank">
                                                                <img alt="eKarte" height="auto"
                                                                     src="https://ekarte.rs/mail/eKarte-w.png"
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;letter-spacing:1px;line-height:24px;text-align:center;text-transform:uppercase;color:#ffffff;">
                                                    Plaćanje neuspešno
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:20px;font-weight:bold;letter-spacing:1px;line-height:20px;text-align:center;text-transform:uppercase;color:#f3a7a7;">
                                                    Račun Vaše platne kartice nije zadužen.
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td style="width:600px;">
                                                            <a href="https://ekarte.rs" target="_blank">
                                                                <img alt="eKarte" height="auto"
                                                                     src="https://ekarte.rs/mail/img/slider-top.jpg"
                                                                     style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;"
                                                                     width="600">
                                                            </a>
                                                        </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td style="width:600px;">
                                                <a href="https://ekarte.rs" target="_blank">
                                                    <img alt="eKarte" height="auto"
                                                         src="https://ekarte.rs/mail/img/slider-bottom.jpg"
                                                         style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;"
                                                         width="600">
                                                </a>
                                            </td>
    ...
    <table
            align="center" border="0" cellpadding="0" cellspacing="0" class="body-section-outlook" style="width:600px;"
            width="600"
    >
        <tr>
            <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
                        ...
                        >
                            ...
                            >
                                <tr>
                                    <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
                    <![endif]-->
                    <div style="background:#f0f5f7;background-color:#f0f5f7;margin:0px auto;max-width:600px;">
                        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                               style="background:#f0f5f7;background-color:#f0f5f7;width:100%;">
                            <tbody>
                            <tr>
                                <td style="direction:ltr;font-size:0px;padding:20px 0;padding-left:15px;padding-right:15px;text-align:center;">
                                    <!--[if mso | IE]>
                                    ...
                                    <div class="mj-column-per-100 mj-outlook-group-fix"
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                <td align="left"
                                                    style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                    <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#2f2f2f;">
                                                        U slučaju uzastopnih greški pozovite vašu banku, naš kontakt
                                                        centar ili plaćanje izvršite preko računa ili eBanking vaše
                                                        banke.
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#2f2f2f;">
                                                        Plaćanje možete izvršiti na žiro račune:
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#2f2f2f;">
                                                        <ul style="margin-top: 0">
                                                            <li style="padding-bottom: 10px"><strong>Unikredit banka
                                                                170-0030031266000-88</strong></li>
                                                            <li><strong>Banca Intesa 160-385867-73</strong></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#2f2f2f;">
                                                        Primalac: <strong>DOO Travel Zone Novi Sad</strong></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left"
                                                    style="font-size:0px;padding:10px 25px;padding-top:5px;word-break:break-word;">
                                                    <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#2f2f2f;">
                                                        Svrha: <strong>eKarte rezervacija</strong></div>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:400;line-height:24px;text-align:center;color:#ABCDEA;">
                                                        KONTAKT PODACI <p style="font-size:16px; color:white">
                                                            {{ $payment['BillToName'] }}, {{ $payment['email'] }}<br> {{ $payment['BillToStreet1'] }}, {{ $payment['BillToPostalCode'] }},
                                                            {{ $payment['BillToCity'] }}, {{ $payment['BillToCountry'] }} </p>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                <td style="font-size:0px;padding:10px 25px;padding-top:0;padding-right:20px;padding-bottom:0px;padding-left:20px;word-break:break-word;">
                                                    ...
                                                    <table
                                                            ...
                                                            style="border-top:solid 2px #ffffff;font-size:1px;margin:0px auto;width:560px;"
                                                            role="presentation" width="560px"
                                                    >
                                                        <tr>
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    <div style="font-family:Helvetica;font-size:13px;font-weight:400;line-height:24px;text-align:center;color:#FFFFFF;">
                                                        <span style="font-size:20px; font-weight:bold">Detalji transakcije</span>
                                                        <br>
                                                        <span style="font-size:15px">OID: {{ $payment['oid'] }}</span>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;font-weight:400;line-height:24px;text-align:center;color:#FFFFFF;">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                <td align="center"
                                                    style="font-size:0px;padding:10px 25px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;font-weight:400;line-height:24px;text-align:center;color:#FFFFFF;">
                                                        <strong>ProcReturnCode</strong></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center"
                                                                                        ...
                                                                                        <table border="0"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="font-size:0;height:30px;vertical-align:middle;width:30px;">
                                                                                                    <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.facebook.com/eKarte.rs/"
                                                                                                       target="_blank">
                                                                                                        <img height="30"
                                                                                ...
                                                                                <tr>
                                                                                    <td style="padding:4px;vertical-align:middle;">
                                                                                        <table border="0"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="font-size:0;height:30px;vertical-align:middle;width:30px;">
                                                                                                    <a href="https://www.instagram.com/ekarte.rs/"
                                                                                                       target="_blank">
                                                                                                        <img height="30"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            ...
                                                                            <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:11px;font-weight:400;line-height:16px;text-align:center;color:#445566;">
                                                                                DOO TRAVEL ZONE NOVI SAD<br> Danila Kiša
                                                                                17, lok.5<br> 21000 Novi Sad, Srbija<br>
                                                                                Tel: +381 21 66 10 111<br> Mob: +381 60
                                                                                747 0 725<br> www.eKarte.rs<br>
                                                                                info@ekarte.rs<br> PIB: 107970815
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center"
                                                                            style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                            <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:11px;font-weight:400;line-height:16px;text-align:center;color:#445566;">
                                                                                &copy; eKarte.rs, Sva prava zadržana.
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                        ...
                                                                        <tr>
                                                                            <td align="center"
                                                                                ...
                                                                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:11px;font-weight:bold;line-height:16px;text-align:center;color:#445566;">
                                                                                    <a class="footer-link"
                                                                                       href="https://ekarte.rs/uslovi-koriscenja/"
                                                                                       style="color: #888888;">Uslovi
                                                                                        korišćenja</a>&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;<a
                                                                                        class="footer-link"
                                                                                        href="https://ekarte.rs/politika-privatnosti/"
                                                                                        style="color: #888888;">Politika
                                                                                    privatnosti</a></div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
