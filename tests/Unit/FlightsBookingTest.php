...
class FlightsBookingTestTest extends TestCase
{
    ...
    public function testFlightsSearchFlightInfo()
    {
        ...
        $this->json('GET', '/api/flights/search/flightInfo/' . $request->id)
            ...
            ->assertJsonPath('flights.search.flightInfo.priceStatus.oldValue.amount', '572999.00')
            ->assertJsonPath('flights.search.flightInfo.priceStatus.oldValue.currency', 'RSD')
            ->assertJsonPath('flights.search.flightInfo.priceStatus.newValue.amount', '572999.00')
    ...
    public function testCheckout()
    {
        ...
        $this->json('GET', '/api/checkout/' . $flightInfo->id)
            ...
            ->assertJsonPath('flights.search.results.groupsData.prices.0.airSolution.0.airPricingInfo.0.chargePenalty.0.price.amount', '17692.00')
            ->assertJsonCount(1, 'flights.search.results.groupsData.prices.0.airSolution.0.airPricingInfo.0.cancelPenalty')
            ->assertJsonPath('flights.search.results.groupsData.prices.0.airSolution.0.airPricingInfo.0.totalFare.amount', '161488.00')
            ...
            ->assertJsonPath('flights.search.results.groupsData.prices.0.airSolution.0.airPricingInfo.0.baggageAllowances.baggageAllowanceInfo.0.baggageDetail.0.basePrice.amount', '7667.00')
            ->assertJsonPath('flights.search.results.groupsData.prices.0.airSolution.0.airPricingInfo.0.baggageAllowances.baggageAllowanceInfo.0.baggageDetail.0.approximateBasePrice.amount', '7667.00')
            ->assertJsonPath('flights.search.results.groupsData.prices.0.airSolution.0.airPricingInfo.0.baggageAllowances.baggageAllowanceInfo.0.baggageDetail.0.totalPrice.amount', '7667.00')
            ->assertJsonPath('flights.search.results.groupsData.prices.0.airSolution.0.airPricingInfo.0.baggageAllowances.baggageAllowanceInfo.0.baggageDetail.0.approximateTotalPrice.amount', '7667.00')
            ->assertJsonPath('flights.search.results.groupsData.prices.0.airSolution.0.airPricingInfo.0.baggageAllowances.baggageAllowanceInfo.0.baggageDetail.1.approximateTotalPrice.amount', '11796.00')
            ->assertJsonPath('flights.search.results.groupsData.prices.0.airSolution.0.agencyCharge.amount', '1980.00')
            ->assertJsonPath('flights.search.results.groupsData.prices.0.airSolution.0.totalPrice.amount', '497650.00')
            ->assertJsonPath('flights.search.results.groupsData.prices.0.airSolution.0.paymentOptionCharge.cache.amount', '3180.00')
            ->assertJsonPath('flights.search.results.groupsData.prices.0.airSolution.0.paymentOptionCharge.intesa.amount', '0.00')
        ...
        $this->json('POST','/api/reservation/' . $flightInfo->id, ['request' => file_get_contents(__DIR__ . '/files/Reservation/reservation.json')])
            ...
            ->assertJsonPath('universalRecord.paymentOptionCharge.cache.amount', '3180.00')
            ->assertJsonPath('universalRecord.paymentOptionCharge.intesa.amount', '0.00')
